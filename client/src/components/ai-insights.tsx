        ...
        {isLoading ? (
          ...
          displayInsights.map((insight) => {
            ...
            return (
              <div 
                key={insight.id} 
                className={`p-3 rounded-lg border ${colorClasses.border} bg-gradient-to-r ${colorClasses.bg} to-transparent transition-all duration-200 hover:scale-[1.02] hover:translate-x-1`}
              >
                <div className="flex items-start">
                  <div className="flex-shrink-0 mt-1">
